...
#  name = input("Type name of wishlist: ")
#  name = name.lower()
#  curCost = 0
#  curItems = 0
#  prevCost = 0
#  prevItems = 0
#
#  path = "projects/wishscraper/lists.txt"
#  ex = os.path.exists(path)
#  # check to make sure the lists.txt exists in the desired directory and if not, create it
#
#  if ex == False:
...
#          curCost = infoList[0]
#          curItems = infoList[1]
#          itemizedList = infoList[2]
#          replace_line(path, lnC, str(curItems) + " " + str(curCost) + " " + name + " " + url + "\n")
#
#          break
#  f.close()
#
...
#
#      while valid == False:
#          link = (input("Invalid URL. Please insert the correct URL to the Amazon wishlist: "))
#          valid = isValidURL(link)
#      url = link
#      infoList = costCalc(url)
#      curCost = infoList[0]
#      curItems = infoList[1]
#      itemizedList = infoList[2]
#      f.write(str(curItems) + " " + str(curCost) + " " + name + " " + link + "\n")
#      f.close()
#
#  # totalCost, items = costCalc(url)
#
#  # print outputs
#  print(itemizedList)
#  print("Previously known total cost was $" + str(prevCost) + " for " + str(prevItems) + " items")
#  print("Current total cost of $" + str(curCost) + " for " + str(curItems) + " items")
#  print("Change of $" + str(round((curCost-prevCost), 2)) + " and " + str(round((curItems-prevItems), 2)) + " items")
